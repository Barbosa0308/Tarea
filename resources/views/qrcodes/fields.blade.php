...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('product_url', null, ['class' => 'form-control-file','accept'=> '.jpg, .png', 'maxlength' => 2048]) !!}
</div>

<!-- Product Url Image Path Field -->
<div class="form-group col-sm-6">
    {!! Form::label('product_url_image_Path', 'Product Url Image Path:') !!}
    {!! Form::file('product_url_image_Path', null, ['class' => 'form-control', 'maxlength' => 255, 'maxlength' => 255]) !!}
</div>
